...
#define APP_ID          @"wx7e416977115319af"               //APPID
#define APP_SECRET      @"ebb31ba837291c45d8a32fc37696a9f3" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"125334501"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"1qazxsw23edcvfr45tgbnhy67ujmko0p"
//支付结果回调页面
