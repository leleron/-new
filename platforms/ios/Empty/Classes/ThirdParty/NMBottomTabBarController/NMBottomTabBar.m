...
//    UIImageView *previousSpacerImageView;
    ...
    for( int i = 0 ; i <tabsCount ; i++){
        ...
        else
        {
            ...
            NSDictionaryOfVariableBindings(previousButton,button);
            NSArray *constraints =
            [NSLayoutConstraint constraintsWithVisualFormat:@"[previousButton]-0-[button]"
...
//    [button setBackgroundImage:backImage forState:UIControlStateSelected];
    [button setBackgroundColor:Color_Bg_celllightblue];
    [button setImage:iconImage forState:UIControlStateNormal];
    [button setImage:selecetedBackImage forState:UIControlStateSelected];
    [button setTitle:text forState:UIControlStateNormal];
    [button setTitleColor:[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0] forState:UIControlStateNormal];
    [button setTitleColor:[UIColor colorWithRed:35.0/255.0 green:156.0/255.0 blue:249.0/255.0 alpha:1.0] forState:UIControlStateSelected];
