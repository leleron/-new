...
-(void)awakeFromNib{
    self.frame = CGRectMake(0, -200, SCREEN_WIDTH, 200);
    if (iPhone5) {
        self.frame = CGRectMake(0, -200, SCREEN_WIDTH, 200);
//        self.btnScan.frame = CGRectMake(self.btnScan.frame.origin.x, self.btnScan.frame.origin.y, self.btnScan.frame.size.width, 50);
    }
