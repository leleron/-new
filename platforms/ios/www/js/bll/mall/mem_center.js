...
function choose_province(obj){
	province=$(obj).val();
	Ajax.call('http://m.flyco.com/mem_center/index/get_city?app_fmt=json&province='+province, '',
		function (s){
			if(s !== null){
...
function choose_city(obj){
	city=$(obj).val();
	Ajax.call('http://m.flyco.com/mem_center/index/get_region?app_fmt=json&city='+city, '',
		function (s){
			//s = eval('(' + s + ')');
